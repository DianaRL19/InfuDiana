...
// Barra de ubicación
    ...
    if (isset($_POST["añadir"])) {
        ...
        if (isset($_POST["fecha_alta"])) {
            ...
            $fecha = DateTime::createFromFormat("Y-m-d", $_POST["fecha_alta"]);
        ...
        if (isset($_FILES["foto"])) {
            if (($_FILES["foto"]["error"] != 0) || ($_FILES["foto"]["type"] != "image/png")) {
                $datos["foto"] = "productoDefault.png";
            } else {
        ...
        if (!$consulta) {
            paginaError("Error al añadir el producto.");
            exit;
        }
    ...
    ?>
        ...
        <section class="bienvenida">
            <h2><img src="../../img/hoja1.png" class="hojaDecorativa">Añadir Producto<img src="../../img/hoja2.png" class="hojaDecorativa"></h2>
        </section>
        <form action="" enctype="multipart/form-data" method="post" class="formularioFiltrado">
            ...
            <input type="date" name="fecha_alta" value="<?php DateTime::createFromFormat("d/m/Y", $datos["fecha_alta"]); ?>">
            <br>
            ...
            <input type="number" name="unidades" value="<?php $datos["unidades"]; ?>">
            <br>
            ...
            <input type="number_format" name="precio_base" value="<?php $datos["precio_base"]; ?>">
            <br>
            ...
            ?>
            <label for="">IVA: </label>
            <input type="number_format" name="iva" value="<?php $datos["iva"]; ?>" placeholder="%">
            <br>
